...
class clinic_related_posts_widget extends WP_Widget {
	/* Widget setup */
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Bài viết liên quan', 'clinic'),
			'order' => 'DESC'
		);
...
// Register widget
function clinic_related_posts_widget_register() {
	register_widget( 'clinic_related_posts_widget' );
}

add_action( 'widgets_init', 'clinic_related_posts_widget_register' );