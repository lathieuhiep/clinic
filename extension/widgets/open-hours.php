...
class clinic_open_hours_widget extends WP_Widget {
	/* Widget setup */
    public function __construct() {
        ...
        parent::__construct( 'open-hours-widget', 'My Theme: Thời gian hoạt động', $clinic_open_hours_widget_ops );
    }
...
// Register widget
function clinic_open_hours_widget_register(): void {
    register_widget( 'clinic_open_hours_widget' );
}

add_action( 'widgets_init', 'clinic_open_hours_widget_register' );