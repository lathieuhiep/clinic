...
class clinic_doctor_slider_widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        add_action('sidebar_admin_setup', array($this, 'check_widget_activation'));
    }

    public function check_widget_activation($index): void
    {
        $widget_id = $this->id_base . '-' . $index;
    ...
    // Tải CSS và JavaScript khi widget được sử dụng
    public function enqueue_custom_scripts(): void
    {
        // Tải CSS
