...
class clinic_Elementor_Addon_Info_Box extends Widget_Base {
	...
	public function get_name(): string {
		return 'clinic-info-box';
	}

	public function get_title(): string {
		return esc_html__( 'Info box', 'clinic' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'img_type',
			[
				'label' => esc_html__('Infobox Type', 'clinic'),
				'type' => Controls_Manager::SELECT,
				'default' => 'img-on-top',
				'label_block' => false,
				'options' => [
					'img-on-top' => esc_html__('Image/Icon On Top', 'clinic'),
					'img-on-left' => esc_html__('Image/Icon On Left', 'clinic'),
					'img-on-right' => esc_html__('Image/Icon On Right', 'clinic'),
				],
			]
		);
		...
		$this->add_control(
			'img_or_icon',
			[
				'label' => esc_html__('Image or Icon', 'clinic'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'none' => [
						'title' => esc_html__('None', 'clinic'),
						'icon' => 'fa fa-ban',
					],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Icon Position', 'clinic'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'condition' => [
					'img_type!' => 'img-on-top',
		...
		$this->add_control(
			'selected_image',
			[
				'label' => esc_html__('Infobox Image', 'clinic'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('This is an icon box', 'clinic'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'rows' => 10,
				'default' => esc_html__('Write a short description, that will describe the title or something informational and useful.', 'clinic'),
		...
		$this->add_control(
			'show_description',
			[
				'label' => esc_html__('Show Description', 'clinic'),
		...
		$this->add_responsive_control(
			'content_alignment',
			[
				'label' => esc_html__('Content Alignment', 'clinic'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => esc_html__('Icon Size', 'clinic'),
		...
		$this->start_controls_tab(
			'icon_normal',
			[
				'label' => esc_html__('Normal', 'clinic'),
			]
		);
		...
		$this->add_control(
			'icon_color',
			[
				'label' => esc_html__('Icon Color', 'clinic'),
