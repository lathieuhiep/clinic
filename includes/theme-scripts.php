...
function clinic_register_front_end(): void
{
	...
	// font google
	wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Anton&family=Arimo:wght@400;700&family=Roboto:wght@400;500;700;900&display=swap', array(), null );
